...
| 7 | Ingénierie d'usage (IEC 62366-1) | `05-iec-62366-usabilite.md` + `usability/` (formatif R3 + **sommatif v0.11 : protocole, grille, modèle de rapport**) | 🟠 protocoles rédigés — exécutions 🔴 R3/R6 |
