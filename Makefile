...
.PHONY: help install install-core test test-rules test-services test-ai dev-up dev-down smoke tree stats
...
test: test-rules test-services test-ai ## Tous les tests
