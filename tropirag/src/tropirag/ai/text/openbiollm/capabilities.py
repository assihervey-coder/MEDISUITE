"""Capacités OpenBioLLM — résolution dynamique depuis le Model Registry.
...
MODEL_ID = "openbiollm-70b"

FALLBACK: dict[str, Any] = {'tasks': ['biomedical_synthesis'], 'modalities': ['text'], 'languages': ['en', 'fr'], 'clinical_risk_max': 'supervised', 'autonomous_diagnosis': False, 'evidence_required': True, 'local_execution': False, 'min_vram_gb': 42.0}
