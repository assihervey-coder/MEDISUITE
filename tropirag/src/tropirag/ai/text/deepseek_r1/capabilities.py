"""Capacités DeepSeek-R1-Distill — résolution dynamique depuis le Model Registry.
...
MODEL_ID = "deepseek-r1-distill-32b"

FALLBACK: dict[str, Any] = {'tasks': ['logical_audit'], 'modalities': ['text'], 'languages': ['en', 'fr'], 'clinical_risk_max': 'assisted', 'autonomous_diagnosis': False, 'evidence_required': True, 'local_execution': True, 'min_vram_gb': 20.0}
