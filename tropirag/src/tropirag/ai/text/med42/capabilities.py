"""Capacités Med42 — résolution dynamique depuis le Model Registry.

La déclaration statique ci-dessous n'est qu'un repli : la source de vérité
est le registre (configs/ai/model_registry.yaml + model_capabilities.yaml).
Toute dérive est donc impossible.
"""
from __future__ import annotations

from typing import Any

MODEL_ID = "med42-v2-70b"

FALLBACK: dict[str, Any] = {
    "tasks": ["clinical_reasoning", "biomedical_synthesis"],
    "modalities": ["text"],
    "languages": ["en", "fr"],
