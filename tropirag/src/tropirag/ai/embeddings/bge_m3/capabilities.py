"""Capacités BGE-M3 — résolution dynamique depuis le Model Registry.
...
FALLBACK: dict[str, Any] = {'tasks': ['embeddings'], 'modalities': ['text'], 'languages': ['multilingual'], 'clinical_risk_max': 'none', 'autonomous_diagnosis': False, 'evidence_required': False, 'local_execution': True, 'min_vram_gb': 0.0}
