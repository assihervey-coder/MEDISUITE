"""Capacités SAM2 Medical (segmentation) — résolution dynamique depuis le Model Registry.
...
MODEL_ID = "sam2-medical"

FALLBACK: dict[str, Any] = {'tasks': ['image_segmentation'], 'modalities': ['image'], 'languages': ['en'], 'clinical_risk_max': 'assisted', 'autonomous_diagnosis': False, 'evidence_required': False, 'local_execution': True, 'min_vram_gb': 0.0}
