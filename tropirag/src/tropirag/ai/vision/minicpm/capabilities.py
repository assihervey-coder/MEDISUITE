"""Capacités MiniCPM-V — résolution dynamique depuis le Model Registry.
...
FALLBACK: dict[str, Any] = {'tasks': ['image_triage'], 'modalities': ['image', 'text'], 'languages': ['en', 'zh'], 'clinical_risk_max': 'assisted', 'autonomous_diagnosis': False, 'evidence_required': False, 'local_execution': True, 'min_vram_gb': 0.0}
