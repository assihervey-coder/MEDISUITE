"""Capacités Whisper Large v3 — résolution dynamique depuis le Model Registry.
...
FALLBACK: dict[str, Any] = {'tasks': ['conversation_transcription'], 'modalities': ['audio', 'text'], 'languages': ['fr', 'en', 'multilingual'], 'clinical_risk_max': 'none', 'autonomous_diagnosis': False, 'evidence_required': False, 'local_execution': True, 'min_vram_gb': 0.0}
