"""Spécialisation Fièvre typhoïde — point d'entrée du module maladie."""
from __future__ import annotations

from typing import Callable

# Résumés cliniques structurés (critères OMS/MSF, seuils, déclarations)
from tropirag.clinical_engine.diseases.enteric_fever import summaries as _summaries
...
def module_info() -> dict:
    return {
        "disease_module": "enteric_fever",
        "label_fr": "Fièvre typhoïde",
