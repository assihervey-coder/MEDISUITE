"""Spécialisation Dengue — point d'entrée du module maladie."""
from __future__ import annotations

from typing import Callable

# Résumés cliniques structurés (critères OMS/MSF, seuils, déclarations)
from tropirag.clinical_engine.diseases.dengue import summaries as _summaries
