"""Spécialisation Arboviroses (chikungunya, zika, fièvre jaune) — point d'entrée du module maladie."""
from __future__ import annotations

from typing import Callable

# Résumés cliniques structurés (critères OMS/MSF, seuils, déclarations)
from tropirag.clinical_engine.diseases.arboviruses import summaries as _summaries
...
def module_info() -> dict:
    return {
        "disease_module": "arboviruses",
        "label_fr": "Arboviroses (chikungunya, zika, fièvre jaune)",
